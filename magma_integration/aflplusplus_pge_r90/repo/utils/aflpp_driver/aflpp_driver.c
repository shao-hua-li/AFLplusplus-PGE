...
extern uint32_t* __afl_area_cntUp_ptr;
extern uint32_t* __afl_area_cnt_ptr;
extern uint32_t __afl_area_cnt_ptr_value;
extern uint32_t __afl_area_cntUp_ptr_value;
...
int main(int argc, char **argv) {
  ...
  __afl_area_cntUp_ptr_value = UINT32_MAX; //@PGE: we don't want to terminate before LLVMFuzzerTestOneInput().
